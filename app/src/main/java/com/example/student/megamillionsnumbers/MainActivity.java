package com.example.student.megamillionsnumbers;
...
public class MainActivity extends ActionBarActivity {
    ...
    private final SensorEventListener mSensorListener = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            if (mAccel > 12){
                Toast toast = Toast.makeText(getApplicationContext(),"Here are your Mega Millions Nubers", Toast.LENGTH_LONG);
                toast.show();
                getRandomNum();
                getRandNumb();
            }
    ...
    private void getRandNumb(){
        ...
        int im = m.nextInt(15) + 1;

        String display = String.valueOf(im);
